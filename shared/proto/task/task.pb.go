...
var file_task_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0xec,
	0x01, 0x0a, 0x0b, 0x74, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30,
...
var file_task_proto_goTypes = []interface{}{
	...
	(*GetCompletedTasksTotalRes)(nil),   // 3: task.GetCompletedTasksTotalRes
	(*CompletedTasksDailyTotalRes)(nil), // 4: task.CompletedTasksDailyTotalRes
	(*CompletedTasksDailyTotal)(nil),    // 5: task.CompletedTasksDailyTotal
	(*Period)(nil),                      // 6: task.Period
	(*Task)(nil),                        // 7: task.Task
	(*timestamppb.Timestamp)(nil),       // 8: google.protobuf.Timestamp
}
var file_task_proto_depIdxs = []int32{
	7,  // 0: task.GetTasksRes.Tasks:type_name -> task.Task
	6,  // 1: task.GetTasksTotalReq.Period:type_name -> task.Period
	5,  // 2: task.CompletedTasksDailyTotalRes.CompletedTasksDailyTotals:type_name -> task.CompletedTasksDailyTotal
	8,  // 3: task.CompletedTasksDailyTotal.date:type_name -> google.protobuf.Timestamp
	8,  // 4: task.Period.StartDate:type_name -> google.protobuf.Timestamp
	8,  // 5: task.Period.EndDate:type_name -> google.protobuf.Timestamp
	8,  // 6: task.Task.DueDate:type_name -> google.protobuf.Timestamp
	8,  // 7: task.Task.CreatedAt:type_name -> google.protobuf.Timestamp
	8,  // 8: task.Task.UpdatedAt:type_name -> google.protobuf.Timestamp
	0,  // 9: task.taskService.GetTasks:input_type -> task.GetTasksReq
	2,  // 10: task.taskService.GetCompletedTasksTotal:input_type -> task.GetTasksTotalReq
	2,  // 11: task.taskService.GetCompletedTasksDailyTotal:input_type -> task.GetTasksTotalReq
	1,  // 12: task.taskService.GetTasks:output_type -> task.GetTasksRes
	3,  // 13: task.taskService.GetCompletedTasksTotal:output_type -> task.GetCompletedTasksTotalRes
	4,  // 14: task.taskService.GetCompletedTasksDailyTotal:output_type -> task.CompletedTasksDailyTotalRes
